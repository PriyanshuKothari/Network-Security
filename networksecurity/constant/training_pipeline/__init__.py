...
DATA_TRANSFORAMATION_TRANSFORMED_DATA_DIR: str = "transformed"
DATA_TRANSFORAMATION_TRANSFORMED_OBJECT_DIR: str = "transformed_object"
...
'''
Model Trainer related constant start with DATA_TRANSFORMATION_VAR_NAME
'''
